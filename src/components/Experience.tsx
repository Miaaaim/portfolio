...
const experiences = [
  {
    ...
    title: '资深产品经理',
    desc: '负责智慧校园SaaS规划迭代，覆盖管理系统、大屏及学生端App/小程序，完成教育局-学校-服务团队分层建模与流程标准化；系统落地1500+学校、150万学生，支撑千万次体测数字化，学生端注册用户增长至20万+。'
  },
  {
    id: 'netease',
    company: '网易',
    ...
    title: '高级产品经理',
    desc: '负责企业服务CRM，重构注册路径、落地页与企微触达，建立A/B测试与标签分群体系，推动自动分层和个性化运营闭环；注册转化率提升12.7%，满意度提升12%，负反馈率下降80%，页面产出效率提升200%。'
  },
  {
    id: 'jielibang',
    company: '接力棒科技',
    ...
    title: '产品经理',
    desc: '负责CRM SaaS平台，主导“获客-转化-留存”全链路，搭建获客系统与数据平台，打通地推、试听、转介绍等渠道；地推用户量提升30%，3个月采集表单20万+。并推进家校互通App，提升家长活跃、续费与转介绍。'
  },
  {
    id: 'eleme',
    company: '饿了么',
